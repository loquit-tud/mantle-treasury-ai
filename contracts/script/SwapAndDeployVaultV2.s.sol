...
contract SwapAndDeployVault is Script {
    ...
    function run() external {
        ...
        // Step 1: Propose withdrawal (to get the correct txHash)
        console.log("Step 1: Propose withdrawal from old vault...");
        bytes32 txHash = oldVault.proposeWithdrawal(deployer, 50_000_000);
        console.log("Proposed txHash:", vm.toString(txHash));

        // Step 2: Execute withdrawal
        console.log("Step 2: Execute withdrawal...");
        oldVault.executeWithdrawal(txHash);
        console.log("Withdrawal executed OK");

        // Step 3: Swap USDT to USDT0
        console.log("Step 3: Swap USDT -> USDT0...");
        ...
        // Step 4: Deploy new vault
        console.log("Step 4: Deploy new vault with USDT0...");
        ...
        // Step 6: Deposit USDT0 into new vault
        ...
        console.log("USDT0 balance in vault:", usdt0Out);
        console.log("");
